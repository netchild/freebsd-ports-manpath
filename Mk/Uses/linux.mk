...
ONLY_FOR_ARCHS_REASON=	Linux compatibility is only available on aarch64 and amd64
.    else
...
_linux_${linux_ARGS}_libssh2=		linux-${linux_ARGS}-libssh2>0:security/linux-${linux_ARG}-libssh2
...
_linux_rl9_tcl86=			linux-rl9-tcl85>0:lang/linux-rl9-tcl86
